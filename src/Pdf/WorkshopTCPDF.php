...
class WorkshopTCPDF extends \TCPDF
{
    ...
    public function Header(): void
    {
        ...
        if ('cover' === $this->type) {
            // Transparent overlay this->setAlpha(0.45); style = array('L' => 0, 'T' => 0,
            // 'R' => 0, 'B' => 0); this->Rect(0, 0, 220, 300, 'DF', $style, array(0, 0, 0));
        }
        ...
        // White background for the table of content
        if ('TOC' === $this->type) {
            // $this->setAlpha(0.95); Border Style
            $style = ['L' => 0, 'T' => 0, 'R' => 0, 'B' => 0];
        ...
        if ('eventPage' === $this->type) {
            ...
            // $this->write2DBarcode('http://sac-kurse.kletterkader.com/kurse-detail/' .
            // $this->objEvent->id, 'QRCODE,H', 175, 267, 25, 25, $style, 'N');
        }
