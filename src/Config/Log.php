...
class Log
{
     ...
     */
    public const string MEMBER_DATABASE_SYNC_SUCCESS = 'MEMBER_DB_SYNC_SUCCESS';

    /**
     * MEMBER_DATABASE_SYNC: Log type if there has been a db transaction error.
     */
    public const string MEMBER_DATABASE_SYNC_TRANSACTION_ERROR = 'MEMBER_DB_SYNC_TRANSACTION_ERROR';

    /**
     * MEMBER_DATABASE_SYNC: Log type when a new member has been inserted.
     */
    public const string MEMBER_DATABASE_SYNC_INSERT_NEW_MEMBER = 'MEMBER_DB_SYNC_INSERT_NEW';
     ...
     */
    public const string MEMBER_DATABASE_SYNC_DISABLE_MEMBER = 'MEMBER_DB_SYNC_DISABLE_MEMBER';

    /**
     * MEMBER_WITH_USER_SYNC: Log type when tl_member has been synced with tl_user.
     */
    public const string MEMBER_WITH_USER_SYNC_SUCCESS = 'MEMBER_WITH_USER_SYNC_SUCCESS';

    /**
     * EVENT: Log type if a user has unsubscribed.
     */
    public const string EVENT_UNSUBSCRIPTION = 'EVENT_UNSUBSCRIPTION';
     ...
     */
    public const string EVENT_SUBSCRIPTION_ERROR = 'EVENT_SUBSCRIPTION_ERROR';

    /**
     * EVENT: Log type when an event registration has been confirmed by a tour guide.
     */
    public const string EVENT_PARTICIPATION_CONFIRM = 'EVENT_PARTICIPATION_CONFIRM';

    /**
     * EVENT: Log type when an event registration has been unconfirmed by a tour guide.
     */
    public const string EVENT_PARTICIPATION_UNCONFIRM = 'EVENT_PARTICIPATION_UNCONFIRM';

    /**
     * DOWNLOAD: Log type when a user has downloaded its certificate of attendance.
     */
    public const string DOWNLOAD_CERTIFICATE_OF_ATTENDANCE = 'DOWNLOAD_CERTIFICATE_OF_ATTENDANCE';

    /**
     * DOWNLOAD: Log type when a user has downloaded the workshop booklet.
     */
    public const string DOWNLOAD_WORKSHOP_BOOKLET = 'DOWNLOAD_WORKSHOP_BOOKLET';

    /**
     * DOWNLOAD: Log type when a user has downloaded the tour list booklet.
     */
    public const string DOWNLOAD_TOUR_LIST_BOOKLET = 'DOWNLOAD_TOUR_LIST_BOOKLET';

    /**
     * MEMBER_DASHBOARD_UPDATE_PROFILE: Log type when a frontend user has
     * updated its profile.
     */
    public const string MEMBER_DASHBOARD_UPDATE_PROFILE = 'MEMBER_DASHBOARD_UPDATE_PROFILE';

    /**
     * CREATE_USER_HOME_DIRECTORY: Log type when home directory for a backend user has
     * been created.
     */
    public const string CREATE_USER_HOME_DIRECTORY = 'CREATE_USER_HOME_DIRECTORY';
     ...
     */
    public const string ANONYMIZE_EVENT_REGISTRATION = 'ANONYMIZE_EVENT_REGISTRATION';

    /**
     * DISABLE_FRONTEND_USER_LOGIN: Log type when a frontend users login has been disabled.
     */
    public const string DISABLE_FRONTEND_USER_LOGIN = 'DISABLE_FRONTEND_USER_LOGIN';

    /**
     * DELETE_FRONTEND_USER: Log type when a frontend user has been deleted.
     */
    public const string DELETE_FRONTEND_USER = 'DELETE_FRONTEND_USER';
