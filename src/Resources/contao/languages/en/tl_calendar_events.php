...
$GLOBALS['TL_LANG']['tl_calendar_events']['coordsCH1903'] = ['Ziel-Koordinaten (CH1903) für Kartenansicht', 'Koordinaten des Zieles im Format <em>2600000, 1200000</em> (CH1903+) oder <em>600000, 200000</em> (CH1903) eingeben. Die Koordinaten können auf <a href="https://map.geo.admin.ch">map.geo.admin.ch</a> und einem Klick mit der rechten Maustaste auf das Ziel herausgelesen und kopiert werden.'];
$GLOBALS['TL_LANG']['tl_calendar_events']['journey'] = ['Anreise mit', 'Geben Sie an, wie zum Event angereist wird.'];
$GLOBALS['TL_LANG']['tl_calendar_events']['linkSacRoutePortal'] = ['Link zu SAC-Tourenportal für Touren-Details', 'Link zu Details der Tour von SAC-CAS Webseite eingeben. Der Link muss mit <a href="https://www.sac-cas.ch/de/huetten-und-touren/sac-tourenportal/">https://www.sac-cas.ch/de/huetten-und-touren/sac-tourenportal/</a> beginnen.'];
