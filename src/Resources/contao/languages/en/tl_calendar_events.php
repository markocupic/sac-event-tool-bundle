...
$GLOBALS['TL_LANG']['tl_calendar_events']['coordsCH1903'] = ['Ziel-Koordinaten (CH1903) für Kartenansicht', 'Bitte geben Sie die Koordinaten des Zieles im Format <em>2600000, 1200000</em> (CH1903+) oder <em>600000, 200000</em> (CH1903) ein. Die Koordinaten können auf <a href="https://map.geo.admin.ch">map.geo.admin.ch</a> und einem Klick mit der rechten Maustaste auf das Ziel herausgelesen und kopiert werden.'];
