...
// Global operations
$GLOBALS['TL_LANG']['tl_event_release_level_policy_package']['new'] = array("Neues Freigabestufen-System anlegen", "Legen Sie ein neues Freigabestufen-System an.");
...
// Fields
$GLOBALS['TL_LANG']['tl_event_release_level_policy_package']['title'] = array("Titel", "Geben Sie einen Titel ein.");
$GLOBALS['TL_LANG']['tl_event_release_level_policy_package']['editheader'] = array("Bearbeiten", "Freigabestufen-System mit ID %s bearbeiten.");
$GLOBALS['TL_LANG']['tl_event_release_level_policy_package']['editheader'] = array("Bearbeiten", "Freigabestufen-System mit ID %s bearbeiten.");
$GLOBALS['TL_LANG']['tl_event_release_level_policy_package']['editheader'] = array("Bearbeiten", "Freigabestufen-System mit ID %s bearbeiten.");
