...
$GLOBALS['TL_LANG']['tl_module']['story_limit'] = ['Gesamtzahl der Beiträge', 'Hier können Sie die Gesamtzahl der Beitr&auml;ge begrenzen. Geben Sie 0 ein, um alle anzuzeigen.'];
$GLOBALS['TL_LANG']['tl_module']['story_eventOrganizers'] = ["Veranstalter\Ortsgruppen einsch&auml;nken", "W&auml;hlen Sie hier die Event-Veranstalter aus, deren Berichte angezeigt werden sollen."];
$GLOBALS['TL_LANG']['tl_module']['eventStoryJumpTo'] = ['Event-Bericht Reader', 'Bitte geben Sie hier die Seite mit dem Event-Reader Modul an.'];
...
$GLOBALS['TL_LANG']['tl_module']['activateMemberAccountNotificationId'] = ['Benachrichtigung bei Mitgliederkonto Aktivierung', ''];
$GLOBALS['TL_LANG']['tl_module']['jumpToWhenNotActivated'] = ['Weiterleitung zur Seite mit Kontoaktivierungsmodul', 'Legen Sie fest zu welcher Seite ein Mitglied weitergeleitet wird, wenn das Mitgliederkonto deaktiviert ist (login = false)'];
