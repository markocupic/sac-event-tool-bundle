...
$GLOBALS['TL_LANG']['tl_user']['addAvatar'] = array('Portrait-Bild hinzuf&uuml;gen', '');
$GLOBALS['TL_LANG']['tl_user']['avatarSRC'] = array('Portrait-Bild', '');
$GLOBALS['TL_LANG']['tl_user']['iban'] = array('IBAN Nr.', 'Geben Sie Ihre IBAN-Nummer ein. Diese wird f&uuml;r die Vergütung ben&ouml;tigt.');
...
$GLOBALS['TL_LANG']['tl_user']['emergencyPhoneName'] = array('Name einer Ihnen anvertrauten Kontaktperson f&uuml;r Notf&auml;lle', 'Geben Sie die den Namen einer Ihnen vertrauten Person an, welche in einem Notfall kontaktiert werden kann.');
$GLOBALS['TL_LANG']['tl_user']['hobbies'] = array('Hobbies', 'Hier kannst du deine Hobbys aufflisten.');
$GLOBALS['TL_LANG']['tl_user']['introducing'] = array('Steckbrief/Kurzpr&auml;sentation', 'Stelle dich in einigen Sätzen kurz vor. Motivation, Beweggr&uuml;nde, History, etc.');
