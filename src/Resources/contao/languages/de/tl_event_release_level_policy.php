...
$GLOBALS['TL_LANG']['tl_event_release_level_policy']['delete'] = array("Löschen", "Freigabestufe mit ID %s löschen.");
...
// Fields
$GLOBALS['TL_LANG']['tl_event_release_level_policy']['level'] = array("Veröffentlichungsstufe", "Geben Sie eine Veröffentlichungsstufe ein. Keine doppelten Einträge!!!");
$GLOBALS['TL_LANG']['tl_event_release_level_policy']['title'] = array("Titel", "Geben Sie für die Freigabestufe einen Namen an.");
$GLOBALS['TL_LANG']['tl_event_release_level_policy']['description'] = array("Beschreibung", "Geben Sie für die Freigabestufe einen Namen ein.");
...
$GLOBALS['TL_LANG']['tl_event_release_level_policy']['allowWriteAccessToAuthor'] = array("Dem Autor Scheibzugriff auf diesem Level gewähren.", "Mit dieser Einstellung gewähren Sie auf diesem Level dem Autor Schreibugriff.");
$GLOBALS['TL_LANG']['tl_event_release_level_policy']['allowWriteAccessToInstructors'] = array("Den Event-Leitern Scheibzugriff auf diesem Level gewähren.", "Mit dieser Einstellung gewähren Sie auf diesem Level den Event-Leitern Schreibugriff.");
