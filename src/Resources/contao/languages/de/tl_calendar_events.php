...
$GLOBALS['TL_LANG']['tl_calendar_events']['suitableForBeginners'] = array("Für Anf&auml;nger geeignet", "Der Event eignet sich für die Teilnahme von Anf&auml;ngern in der entsprechenden Bergsport-Disziplin.");
...
$GLOBALS['TL_LANG']['tl_calendar_events']['instructorId'] = array("Leiter ausw&auml;hlen. (Der Erstaufgef&uuml;hrte ist der Hauptleiter)", "W&auml;hlen Sie bitte einen oder mehrere Leiter aus. Der Erstaufgef&uuml;hrte ist der Hauptverantwortliche und erhält die Onlineanmeldungen.");
...
$GLOBALS['TL_LANG']['tl_calendar_events']['eventSubstitutionText'] = array("Ersatz-/Ausweichtour, falls die Tour nicht wie ausgeschrieben durchgef&uuml;hrt wurde", "Geben Sie, falls n&ouml;tig Informationen zur Ersatz-/Ausweichtour an.");
