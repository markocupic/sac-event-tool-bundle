...
/** Cron jobs */
$GLOBALS['TL_CRON']['monthly']['replaceDefaultPassword'] = array(MonthlyCron::class, 'replaceDefaultPasswordAndSendNew');
$GLOBALS['TL_CRON']['hourly']['syncSacMemberDatabase'] = array(HourlyCron::class, 'syncSacMemberDatabase');
$GLOBALS['TL_CRON']['hourly']['syncMemberWithUser'] = array(HourlyCron::class, 'syncMemberWithUser');
$GLOBALS['TL_CRON']['daily']['generateWorkshopPdfBooklet'] = array(DailyCron::class, 'generateWorkshopPdfBooklet');
$GLOBALS['TL_CRON']['daily']['anonymizeOrphanedCalendarEventsMemberDataRecords'] = array(DailyCron::class, 'anonymizeOrphanedCalendarEventsMemberDataRecords');
