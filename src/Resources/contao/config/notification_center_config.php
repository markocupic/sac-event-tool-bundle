...
(
    ...
    (
        ...
        'email_subject'        => array('event_name'),
        'email_text'           => array('event_name', 'instructor_name', 'instructor_email', 'participant_name', 'participant_email', 'participant_street', 'participant_postal', 'participant_city', 'participant_date_of_birth', 'participant_sac_member_id', 'participant_contao_member_id', 'participant_phone', 'participant_emergency_phone', 'participant_emergency_phone_name', 'participant_vegetarian', 'participant_notes', 'event_link_detail'),
        'email_html'           => array('event_name', 'instructor_name', 'instructor_email', 'participant_name', 'participant_email', 'participant_street', 'participant_postal', 'participant_city', 'participant_date_of_birth', 'participant_sac_member_id', 'participant_contao_member_id', 'participant_phone', 'participant_emergency_phone', 'participant_emergency_phone_name', 'participant_vegetarian', 'participant_notes', 'event_link_detail'),
    ),
    ...
    (
        ...
        'email_replyTo'        => array('instructor_email'),
        'email_subject'        => array('event_name'),
        'email_text'           => array('event_name', 'instructor_name', 'instructor_email', 'participant_name'),
        'email_html'           => array('event_name', 'instructor_name', 'instructor_email', 'participant_name'),
    ),
    // Type
