...
(
	...
	(
		...
		'email_text'           => array('event_name', 'event_type', 'event_add_iban', 'event_iban', 'event_ibanBeneficiary', 'event_course_id', 'instructor_name', 'instructor_email', 'participant_uuid', 'participant_name', 'participant_email', 'participant_street', 'participant_postal', 'participant_city', 'participant_date_of_birth', 'participant_sac_member_id', 'participant_ahv_number', 'participant_contao_member_id', 'participant_section_membership', 'participant_mobile', 'participant_emergency_phone', 'participant_emergency_phone_name', 'participant_food_habits', 'participant_notes', 'participant_state_of_subscription', 'participant_has_lead_climbing_education', 'event_id', 'event_link_detail', 'event_state'),
		'email_html'           => array('event_name', 'event_type', 'event_add_iban', 'event_iban', 'event_ibanBeneficiary', 'event_course_id', 'instructor_name', 'instructor_email', 'participant_uuid', 'participant_name', 'participant_email', 'participant_street', 'participant_postal', 'participant_city', 'participant_date_of_birth', 'participant_sac_member_id', 'participant_ahv_number', 'participant_contao_member_id', 'participant_section_membership', 'participant_mobile', 'participant_emergency_phone', 'participant_emergency_phone_name', 'participant_food_habits', 'participant_notes', 'participant_state_of_subscription',  'participant_has_lead_climbing_education', 'event_id', 'event_link_detail', 'event_state'),
	),
