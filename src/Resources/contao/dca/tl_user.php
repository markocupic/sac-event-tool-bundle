...
foreach ($GLOBALS['TL_DCA']['tl_user']['palettes'] as $k => $v)
{
    if ($k == 'login')
    {
        $GLOBALS['TL_DCA']['tl_user']['palettes'][$k] = str_replace(';{backend_legend', ',dateOfBirth,street,postal,city,phone,mobile,website;{emergency_phone_legend},emergencyPhone,emergencyPhoneName;{bank_account_legend},iban;{frontend_legend},avatarSRC;{backend_legend', $GLOBALS['TL_DCA']['tl_user']['palettes'][$k]);
    }
    else
    {
        $GLOBALS['TL_DCA']['tl_user']['palettes'][$k] = str_replace(';{backend_legend', ',sacMemberId,firstname,lastname,dateOfBirth,gender,street,postal,city,state,country,phone,mobile,website;{frontend_legend},avatarSRC;{backend_legend', $GLOBALS['TL_DCA']['tl_user']['palettes'][$k]);
        $GLOBALS['TL_DCA']['tl_user']['palettes'][$k] = str_replace(';{backend_legend', ';{leiter_legend},iban,leiterQualifikation;{backend_legend', $GLOBALS['TL_DCA']['tl_user']['palettes'][$k]);
    }
}
 ...
 */
$GLOBALS['TL_DCA']['tl_user']['palettes']['extend'] = str_replace('{calendars_legend},', '{calendars_legend},calendar_containers,calendar_containerp,', $GLOBALS['TL_DCA']['tl_user']['palettes']['extend']);
$GLOBALS['TL_DCA']['tl_user']['palettes']['custom'] = str_replace('{calendars_legend},', '{calendar_containers_legend},calendar_containers,calendar_containerp,', $GLOBALS['TL_DCA']['tl_user']['palettes']['custom']);
