...
// Onload callbacks
$GLOBALS['TL_DCA']['tl_user']['config']['onload_callback'][] = ['tl_user_sac_event_tool', 'onloadCallback'];
...
Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ...
    ->addField(['sacMemberId', 'firstname', 'lastname', 'sectionId', 'dateOfBirth', 'street', 'postal', 'city', 'phone', 'mobile', 'website'], 'name_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
...
$arrRemove = ['alternate_email', 'alternate_email_2'];
...
Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ...
    ->addLegend('recission_legend', 'event_tool_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_BEFORE)
    ->addField(['iban'], 'bank_account_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->addField(['sacMemberId', 'firstname', 'lastname', 'dateOfBirth', 'street', 'postal', 'city', 'phone', 'mobile', 'website'], 'name_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->addField(['hideInFrontendListings', 'userRole'], 'role_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->addField(['leiterQualifikation'], 'instructor_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->addField(['admin'], 'admin_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->addField(['generateMainInstructorContactDataFromDb', 'disableOnlineRegistration'], 'event_tool_legend', Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
...
$arrRemove = ['name', 'alternate_email', 'alternate_email_2'];
foreach ($arrRemove as $field)
{
...
$GLOBALS['TL_DCA']['tl_user']['fields']['sectionId'] = [
    ...
    'options'   => [4250, 4251, 4252, 4253, 4254],
    'sql'       => "blob NULL",
];
...
$GLOBALS['TL_DCA']['tl_user']['fields']['emergencyPhoneName'] = [
    ...
    'search'    => true,
    'inputType' => 'text',
    'eval'      => ['maxlength' => 64, 'mandatory' => false, 'decodeEntities' => true, 'tl_class' => 'clr'],
    'sql'       => "varchar(64) NOT NULL default ''",
];
