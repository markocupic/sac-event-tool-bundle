...
(
    ...
    'palettes' => array
    (
        'default' => '{contact_legend},name,canton,altitude,huettenwart,phone,email,url;{image_legend},singleSRC;{details_legend},huettenchef,capacity,coords,geoadminlink,openingTime',
    ),
    ...
    (
        ...
        'name'         => array
        (
            'label'     => &$GLOBALS['TL_LANG']['tl_cabanne_sac']['title'],
            'exclude'   => true,
            'search'    => true,
            'sorting'   => true,
            'inputType' => 'text',
        ...
        'coords'       => array
        (
            'label'     => &$GLOBALS['TL_LANG']['tl_cabanne_sac']['coords'],
            'exclude'   => true,
            'search'    => true,
            'sorting'   => true,
            'inputType' => 'text',
        ...
        'geoadminlink' => array
        (
            'label'     => &$GLOBALS['TL_LANG']['tl_cabanne_sac']['geoadminlink'],
            'exclude'   => true,
            'search'    => true,
            'sorting'   => true,
            'inputType' => 'text',
