...
PaletteManipulator::create()
    ...
    ->addField(['SAC_EVT_FTPSERVER_MEMBER_DB_BERN_HOSTNAME'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_FTPSERVER_MEMBER_DB_BERN_USERNAME'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_FTPSERVER_MEMBER_DB_BERN_PASSWORD'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_SAC_SECTION_IDS'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_SECTION_NAME'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_DEFAULT_BACKEND_PASSWORD'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_TOUREN_UND_KURS_ADMIN_NAME', 'SAC_EVT_TOUREN_UND_KURS_ADMIN_EMAIL'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_TEMP_PATH'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_AVATAR_MALE'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_AVATAR_FEMALE'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_BE_USER_DIRECTORY_ROOT'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_FE_USER_DIRECTORY_ROOT'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_FE_USER_AVATAR_DIRECTORY'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_EVENT_STORIES_UPLOAD_PATH'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_EVENT_DEFAULT_PREVIEW_IMAGE_SRC'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_WORKSHOP_FLYER_SRC'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_ASSETS_DIR'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_COURSE_CONFIRMATION_TEMPLATE_SRC'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_COURSE_CONFIRMATION_FILE_NAME_PATTERN'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_EVENT_MEMBER_LIST_FILE_NAME_PATTERN'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_EVENT_TOUR_INVOICE_TEMPLATE_SRC'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_EVENT_MEMBER_LIST_TEMPLATE_SRC'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_EVENT_TOUR_INVOICE_FILE_NAME_PATTERN'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_SAC_MEMBER_DATABASE_SYNC'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_ADD_NEW_MEMBER'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_DISABLE_MEMBER'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_EVENT_CONFIRMATION_DOWNLOAD'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_EVENT_UNSUBSCRIPTION'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_EVENT_SUBSCRIPTION'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_EVENT_SUBSCRIPTION_ERROR'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_LOG_COURSE_BOOKLET_DOWNLOAD'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_ACCEPT_REGISTRATION_EMAIL_TEXT'], 'sacEventTool_legend', PaletteManipulator::POSITION_APPEND)
    //
    ->addField(['SAC_EVT_WORKSHOP_FLYER_YEAR'], 'sacWorkshopFlyer_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_WORKSHOP_FLYER_CALENDAR_ID'], 'sacWorkshopFlyer_legend', PaletteManipulator::POSITION_APPEND)
    ->addField(['SAC_EVT_WORKSHOP_FLYER_COVER_BACKGROUND_IMAGE'], 'sacWorkshopFlyer_legend', PaletteManipulator::POSITION_APPEND)
...
$GLOBALS['TL_DCA']['tl_settings']['fields']['SAC_EVT_WORKSHOP_FLYER_CALENDAR_ID'] = [
...
$GLOBALS['TL_DCA']['tl_settings']['fields']['SAC_EVT_WORKSHOP_FLYER_YEAR'] = [
...
$GLOBALS['TL_DCA']['tl_settings']['fields']['SAC_EVT_ACCEPT_REGISTRATION_EMAIL_TEXT'] = [
    ...
    'inputType' => 'textarea',
    'eval'      => ['mandatory' => true, 'preserveTags' => true, 'allowHtml' => true, 'decodeEntities' => false, 'tl_class' => 'clr'],
];
