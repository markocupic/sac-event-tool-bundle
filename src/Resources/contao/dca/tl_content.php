...
if (Input::get('do') == 'sac_calendar_events_tool')
{
    ...
    $GLOBALS['TL_DCA']['tl_content']['config']['onload_callback'][] = ['tl_content_calendar', 'generateFeed'];
    $GLOBALS['TL_DCA']['tl_content']['list']['operations']['toggle']['button_callback'] = ['tl_content_calendar', 'toggleIcon'];
}

// Callbacks
$GLOBALS['TL_DCA']['tl_content']['config']['onload_callback'][] = ['tl_content_sac_event_tool', 'setPalette'];
...
$GLOBALS['TL_DCA']['tl_content']['fields']['cabanneSac'] = [
    ...
    'search'           => true,
    'inputType'        => 'select',
    'options_callback' => ['tl_content_sac_event_tool', 'getCabannes'],
...
$GLOBALS['TL_DCA']['tl_content']['fields']['userList_userRoles'] = [
    ...
    'filter'           => true,
    'inputType'        => 'select',
    'options_callback' => ['tl_content_sac_event_tool', 'optionsCallbackUserRoles'],
...
$GLOBALS['TL_DCA']['tl_content']['fields']['userList_template'] = [
    ...
    'exclude'          => true,
    'inputType'        => 'select',
    'options_callback' => ['tl_content_sac_event_tool', 'getUserListTemplates'],
    'eval'             => ['tl_class' => 'w50'],
...
$GLOBALS['TL_DCA']['tl_content']['fields']['userList_partial_template'] = [
    ...
    'exclude'          => true,
    'inputType'        => 'select',
    'options_callback' => ['tl_content_sac_event_tool', 'getUserListPartialTemplates'],
    'eval'             => ['tl_class' => 'w50'],
    'sql'              => "varchar(64) NOT NULL default ''"
];
