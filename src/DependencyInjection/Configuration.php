                        ...
                        ->arrayNode('backend')
                            ...
                            ->children()
                                ...
                                ->arrayNode('rescission_cause')
                                    ...
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/defaults/_user_rescission_cause_opt.yaml')))
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('frontend')
                        ...
                        ->arrayNode('config')
                            ...
                            ->children()
                                ...
                                ->arrayNode('avalanche_level')
                                    ->prototype('scalar')->end()
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/defaults/_avalanche_level_opt.yaml')))
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('course')
                        ...
                        ->arrayNode('config')
                            ...
                            ->children()
                                ->arrayNode('car_seat_info')
                                    ->prototype('scalar')->end()
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/defaults/_car_seat_opt.yaml')))
                                ->end()
                                ->arrayNode('ticket_info')
                                    ->prototype('scalar')->end()
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/defaults/_ticket_opt.yaml')))
                                ->end()
                            ->end()
                        ->end()
                    ->end()
