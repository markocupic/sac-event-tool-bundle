                        ...
                        ->arrayNode('config')
                            ...
                            ->children()
						        ...
						        ->arrayNode('avalanche_level')
							        ->prototype('scalar')->end()
							        ->normalizeKeys(false)
							        ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/_avalanche_level.yaml')))
						        ->end()
                            ->end()
                        ->end()
                        ->arrayNode('course')
                            ...
                            ->children()
                                ->arrayNode('levels')
                                    ...
                                    ->prototype('scalar')->end()
                                    ->normalizeKeys(false)
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/_course_levels.yaml')))
                                ->end()
