                        ...
                        ->arrayNode('config')
                            ...
                            ->children()
                                ->arrayNode('duration_info')
                                    ...
                                    ->normalizeKeys(false)
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/defaults/_event_duration.yaml')))
                                ->end()
                                ->arrayNode('avalanche_level')
                                    ->prototype('scalar')->end()
                                    ->normalizeKeys(false)
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/defaults/_avalanche_level.yaml')))
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('course')
                            ...
                            ->children()
                                ->arrayNode('levels')
                                    ...
                                    ->prototype('scalar')->end()
                                    ->normalizeKeys(false)
                                    ->defaultValue(Yaml::parse(file_get_contents($this->projectDir.'/vendor/markocupic/sac-event-tool-bundle/config/defaults/_course_levels.yaml')))
                                ->end()
