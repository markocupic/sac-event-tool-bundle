...
$GLOBALS['TL_CONFIG']['SAC-EVENT-TOOL-CONFIG']['MEMBER-SUBSCRIPTION-STATE'] = [
    ...
    EventSubscriptionLevel::SUBSCRIPTION_ON_WAITINGLIST,
...
$GLOBALS['TL_CONFIG']['SAC-EVENT-TOOL-CONFIG']['durationInfo'] = [
    ...
    '2 Vormittage' => ['dateRows' => 2],
    '3 Vormittage' => ['dateRows' => 3],
    '4 Vormittage' => ['dateRows' => 4],
    '5 Vormittage' => ['dateRows' => 5],
    '6 Vormittage' => ['dateRows' => 6],
    '7 Vormittage' => ['dateRows' => 7],
    '1 Abend' => ['dateRows' => 1],
    '2 Abende' => ['dateRows' => 2],
    '3 Abende' => ['dateRows' => 3],
    '4 Abende' => ['dateRows' => 4],
