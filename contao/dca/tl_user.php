...
$GLOBALS['TL_DCA']['tl_user']['fields']['hideUser'] = [
	// Notfallkonzept: Allows to hide users in the frontend
	// Test users: Test users should not be visible in the tour instructor listing
	'exclude'   => true,
	'filter'    => true,
	'search'    => true,
	'sorting'   => true,
