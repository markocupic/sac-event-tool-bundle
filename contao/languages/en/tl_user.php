...
// Fields
$GLOBALS['TL_LANG']['tl_user']['tstamp'] = ['Änderungsdatum', 'Wählen Sie das Änderungsdatum aus.'];
...
$GLOBALS['TL_LANG']['tl_user']['avatar'] = ['Portrait-Bild', ''];
...
$GLOBALS['TL_LANG']['tl_user']['hideUser'] = ['Benutzer unsichtbar im Frontend (Notfallkonzept)', 'Geben Sie an, ob der Benutzer in Listing Modulen im Frontend nicht angezeigt werden soll (Notfallkonzept).'];
